...
@pytest.mark.parametrize("hash_type,input_str,expected", [
    ...
    ("NTLM", "test", "0CB6948805F797BF2A82807973B89537"),  # fail
    ("LM", "test", "01FC5A6BE7BC6929AAD3B435B51404EE"),
])
def test_known_hashes(hash_type, input_str, expected): # hash type, string to hash, expected results, the length of the expected hash
